...
<title>Billing App Header</title>
		...
		<nav class="navbar navbar-expand-sm navbar-default">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="welcome"><img
					src="images/logo.png" alt="Logo" height="34" width="256"></a> <a
					class="navbar-brand hidden" href="welcome"><img
					src="images/logo2.png" height="34" width="26" alt="Logo"></a>
			</div>
			...
			<div id="main-menu" class="main-menu collapse navbar-collapse">
				<ul class="nav navbar-nav">
					...
					<h3 class="menu-title">Supplier And PO Details</h3>
					<!-- /.menu-title -->
					<li class="menu-item-has-children dropdown"><a href="#"
						class="dropdown-toggle" data-toggle="dropdown"
						aria-haspopup="true" aria-expanded="false"> <i
							class="menu-icon fa fa-laptop"></i>Manage Supplier
					</a>
						<ul class="sub-menu children dropdown-menu">
							<li><i class="fa fa-file-word-o"></i><a href="add_SUPPLIER">Add
									New Supplier</a></li>
							<li><i class="fa fa-file-word-o"></i><a
								href="manage_SUPPLIER">Update Supplier</a></li>
							<li><i class="fa fa-file-word-o"></i><a
								href="manage_SUPPLIER">All Supplier</a></li>
						</ul></li>
					<li class="menu-item-has-children dropdown"><a href="#"
						class="dropdown-toggle" data-toggle="dropdown"
						aria-haspopup="true" aria-expanded="false"> <i
							class="menu-icon fa fa-table"></i>Manage PO
					</a>
						<ul class="sub-menu children dropdown-menu">
							<li><i class="fa fa-file-word-o"></i><a href="add_PO">Add
									New PO</a></li>
							<li><i class="fa fa-file-word-o"></i><a href="manage_PO">Update
									PO</a></li>
							<li><i class="fa fa-file-word-o"></i><a href="manage_PO">All
									PO</a></li>
						</ul></li>
					<!-- <li class="menu-item-has-children dropdown"><a href="#"
						class="dropdown-toggle" data-toggle="dropdown"
						aria-haspopup="true" aria-expanded="false"> <i
							class="menu-icon fa fa-th"></i>Manage Invoice
					</a>
						<ul class="sub-menu children dropdown-menu">
							<li><i class="menu-icon fa fa-th"></i><a href="add_INVOICE">Add
									New Invoice</a></li>
							<li><i class="menu-icon fa fa-th"></i><a
								href="manage_INVOICE">Update Invoice</a></li>
							<li><i class="menu-icon fa fa-th"></i><a
								href="manage_INVOICE">All Invoice</a></li>
						</ul></li> -->
					...
					<li class="menu-item-has-children dropdown"><a href="#"
						class="dropdown-toggle" data-toggle="dropdown"
						aria-haspopup="true" aria-expanded="false"> <i
							class="menu-icon fa fa-th"></i>Manage Reports
					</a>
						<ul class="sub-menu children dropdown-menu">
							<li><i class="menu-icon fa fa-th"></i><a href="pnl_Report">Profit
									And Loss Report</a></li>
							<li><i class="menu-icon fa fa-th"></i><a
								href="outstanding_Report">OutStanding Report</a></li>
						</ul></li>
				...
				<div class="col-sm-5">
					<div class="user-area dropdown float-right">
						...
						<div class="user-menu dropdown-menu">
							<a class="nav-link" href="update_user"><i class="fa fa- user"></i>My
								Profile</a> <a class="nav-link" href="#"><i class="fa fa- user"></i>Notifications
								<span class="count">13</span></a> <a class="nav-link"
								href="logout"><i class="fa fa-power -off"></i>Logout</a>
						</div>
					</div>
